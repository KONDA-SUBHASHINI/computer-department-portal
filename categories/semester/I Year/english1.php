...
<body>
    <div class="hover-box">
        <h1 class="eng-h1">ENGLISH</h1><br><br>
        <?php
        include("../../../includes/connection.php");

        // Display file information with download and view buttons
        $sql = "SELECT * FROM year1tb where subjectname='ENGLISH'";
        ...
        if ($result && mysqli_num_rows($result) > 0) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                // $downloadLink = '/public_html/year1qp/' . $pdfs;
                // $viewLink = '/public_html/year1qp/' . $pdfs;
